...
<div class="row" id="row-form">
	<div class="col-sm-12" style="margin-bottom:5px "><h2>Tambah Ukuran Kertas</h2><hr></div>
	<div class="col-sm-2"></div>
	<div class="col-sm-8">
		<form method="POST" action="{{asset('proses-tambahUkuranKertas')}}">
			
			<input type="hidden" id="_token" name="_token" value="{{csrf_token()}}">
			
			<div class="form-group {{ $errors->has('nama') ? 'has-danger' : ''}}">
				<label for="nama">Ukuran Kertas</label>
